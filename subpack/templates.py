...
# extend Template Map for some Templates in German Wikipedia. Not every English Template has a German counterpart.
TEMPLATE_MAP = {
    "!": "&#124;",
    "!!": "&#124;&#124;",
    "=": "&#61;",
	...
	"Tabellenkopf_Auszeichnungen": table_start,
    "End": table_end,
	...
	"Abflusstabelle": table_start,
	"AbkAntA": table_start,
	"Abkürzungen_Musikinstrumente": table_start,
	"Abstammung": table_start,
	"AfM-Tabelle": table_start,
	"Anlassfarbentabelle": table_start,
	"AOL-Ranges": table_start,
	"Arbeitslosigkeit_weltweit": table_start,
	"Arbeitslosigkeit-Alterklassen_Europa": table_start,
	"Badmintonbox2": table_start,
	"Bahnhofsliste": table_start,
	"Chartplatzierungen": table_start,
	"Infobox_Chartplatzierungen": table_start,
	"Darstellertabelle": table_start,
	"Charttabelle": table_start,
	"Bevölkerungsentwicklung": table_start,
	"Démographie": table_start,
	"Einwohnerentwicklung": table_start,
	"Einwohnerzahlen": table_start,
	"Ewige_Bundesligatabelle_(American_Football)": table_start,
	"Flugzeugdaten": table_start,
	"Infobox_Astronomisches_Objekt": table_start,
	"Tabakzusatzstoffe": table_start,
	"Infobox_Musikalbum": table_start,
	"Infobox_Band": table_start,
	"Infobox_Plattenlabel": table_start,
	"Infobox_Musikinstrument": table_start,
	"Infobox_Song": table_start,
	"Infobox_Motorrad": table_start,
	"Infobox_Crashtest_PKW": table_start,
	"Klimatabelle": table_start,
	"Kyrillischer_Buchstabe": table_start,
	"Nachbargebirge": table_start,
	"Nachbargemeinden": table_start,
	"Nachbarwoiwodschaften": table_start,
	"Nationalparkdetail": table_start,
	"NaturGeoTabelle_DE": table_start,
	"Navigationsleiste_Musik/Tabelle": table_start,
	"Navigationsleiste_Musik": table_start,
	"Navileiste_Stadtbahn_Essen": table_start,
	"Navileiste_U-Bahn_Frankfurt" : table_start,
	"Navileiste_U-Bahn_Nuernberg": table_start,
	"Infobox_Elementgruppe": table_start,
	"Protein_Orthologe": table_start,
	"Prozentbalken": table_start,
	"Radargerätedaten": table_start,
	"Navileiste_S-Bahn_Rhein-Main": table_start,
	"Schema_Kraftwerksgruppe_Obere_Ill-Lünersee": table_start,
	"Schlusstabelle": table_start,
	"Tabellenzeile_Hochschulliste_DDR": table_start,
	"Tabellenzeile_Teilnehmer_MOSAiC-Expedition": table_start,
	"Titelliste": table_start,
	"Tornado-Chart": table_start,
	"Unicodetabelle": table_start,
