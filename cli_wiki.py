...
# 	)
#
	dump_path = "./english_data/enwiki-latest-pages-articles.xml.bz2"
	page_table_path = "./english_data/enwiki-latest-page.sql.gz"
	categorylinks_table = "./english_data/enwiki-latest-categorylinks.sql.gz"
	db_path = "./english_data/sqlite3_db/fastSense.db"
	output_path = "./english_data/output"
	corenlp_classpath = os.path.join("./english_data/stanford-corenlp-4.2.0", "*")

	WikiConverter.run(
		dump_path=dump_path,
		page_table_path=page_table_path,
		categorylinks_table_path=categorylinks_table,
		db_path=db_path,
		output_path=output_path,
		output_file_count=4,
		corenlp_classpath=corenlp_classpath,
		test_set_sizes=test_set_sizes,
		print_progress=True
	)
